...
> 
class UniqueExpireCache: public AbstractCache<TKey, TValue, Poco::UniqueExpireStrategy<TKey, TValue>, TMutex, TEventMutex>
{
public:
	UniqueExpireCache():
		AbstractCache<TKey, TValue, Poco::UniqueExpireStrategy<TKey, TValue>, TMutex, TEventMutex>(Poco::UniqueExpireStrategy<TKey, TValue>())
	{
	}
