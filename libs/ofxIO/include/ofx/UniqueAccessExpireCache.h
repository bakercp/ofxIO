...
> 
class UniqueAccessExpireCache: public AbstractCache<TKey, TValue, Poco::UniqueAccessExpireStrategy<TKey, TValue>, TMutex, TEventMutex>
{
public:
	UniqueAccessExpireCache():
        AbstractCache<TKey, TValue, Poco::UniqueAccessExpireStrategy<TKey, TValue>, TMutex, TEventMutex>(Poco::UniqueAccessExpireStrategy<TKey, TValue>())
	{
	}
